    ...
    return {
        imports: {
            ...
            "__extjs_6dee770b9e5409ec762e74ce055417295f070f05": function($0, $1) {
                $1 = Module.STDWEB_PRIVATE.to_js($1);Module.STDWEB_PRIVATE.from_js($0, (function(){var req = new XMLHttpRequest (); req.addEventListener ("load" , function (){var cb = ($1); cb (JSON.parse (req.responseText)); cb.drop ();}); req.open ("GET" , "json/pg6.json"); req.send ();})());
            },
