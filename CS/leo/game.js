class Building {
    ...
    generateShopHTML() {
        ...
        let html = `<b>${this.name}</b></br>You have <b>${this.amount}</b> ${this.name.toLowerCase()}(s).</br>Each ${this.name.toLowerCase()} produces <b>${format(singleEffect)}</b> Leos.</br>All of your ${this.name.toLowerCase()}(s) combined produces <b>${format(this.effect)}</b> Leos.</br>${this.generateBuyButtons()}</br>${this.generateUpgradeButtons()}`;
        return html;
    }
}
...
let game = {
    ...
    buildings: [
        ...
        new Building('Cursor', 15, 0.1, [
            ...
            new Upgrade('Thousand Fingers', 100000, 'Mouse and cursors gain +0.1 leos for every non-cursor building owned', 25, 0.1),
            new Upgrade('Million Fingers', 10000000, 'Mouse and cursors gain +0.5 leos for every non-cursor building owned', 50, 0.5),
            new Upgrade('Billion Fingers', 100000000, 'Mouse and cursors gain +5 leos for every non-cursor building owned', 100, 5),
            new Upgrade('Trillion Fingers', 1000000000, 'Mouse and cursors gain +50 for every non-cursor building owned', 150, 50),
            new Upgrade('Quadrillion Fingers', 10000000000, 'Mouse and cursors gain +500 leos for each non-cursor building owned', 200, 500),
        ...
        new Building('Wizard Tower', 330000000, 44000, [
            ...
            new Upgrade('Lemancy', 165000000000000000000, 'Wizard towers are twice as efficient', 200),
        ...
        new Building('Time Machine', 14000000000000, 65000000, [
            ...
            new Upgrade('leoietopian moments of maybe', 7000000000000000000000000000, 'Time machines are twice as efficient', 250),
        ...
        new Building('Chancemaker', 26000000000000000, 21000000000, [
            new Upgrade('Your lucky leo', 260000000000000000, 'Chancemakers are twice as efficient', 1),
        ...
        new Building('Java Console', 71000000000000000000, 1100000000000, [
            ...
            new Upgrade('Leos++', 35500000000000000000000000000000000, 'Java consoles are twice as efficient', 250),
    ...
    updateDisplays () {
        ...
        document.title = 'Leo Clicker | ' + format(player.cookies);
